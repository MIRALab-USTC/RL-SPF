...
# seed_id=(1)
# nohup ./run_ofenet_seed.sh > ./my_log/seed 2>&1 &
...
do
    ...
    h=$[${#seed_id[@]}-1]
    CUDA_VISIBLE_DEVICES=${gpu_id[h]} nohup python -u eager_main_ofePaper.py \
                        --policy ${algo} \
                        --env ${env_id[h]}-v2 \
                        ...
                        --save_model \
                        --dir-root "./output_${algo}" \
                        > ./my_log/exp_${algo}_${env_id[h]}_ofePaper_s${seed_id[j]}.log 2>&1
